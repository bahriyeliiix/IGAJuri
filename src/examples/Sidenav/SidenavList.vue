  ...
  >
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <sidenav-item
          to="/life-map"
          :class="getRoute() === 'life-map' ? 'active' : ''"
          :navText="isRTL ? 'الجداول' : 'Life Map'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          to="/anketler"
          :class="getRoute() === 'anketler' ? 'active' : ''"
          :navText="isRTL ? 'الجداول' : 'ANKETLER'"
        >
          <template v-slot:icon>
      ...
      <!-- <li class="nav-item">
        <sidenav-item
          ...
          :class="getRoute() === 'user-health-report' ? 'active' : ''"
          :navText="isRTL ? 'الجداول' : 'Kullanıcı Sağlık Grafikleri'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'الجداول' : 'Listeler'"
        >
          <template v-slot:icon>
      ...
      <li class="nav-item">
        <sidenav-item
          ...
          :navText="isRTL ? 'حساب تعريفي' : 'Role'"
        >
          <template v-slot:icon>
            <i class="ni ni-single-02 text-dark text-sm opacity-10"></i>
          </template>
