<template>
            ...
            <table class="table table-hover align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr v-else v-for="(item, index) in paginatedData" :key="item.id">
                  ...
                  <td>
                    <span class="text-xs font-weight-bold">{{ item.imageName }}</span>
                  </td>
                  <td>
                    <span class="text-xs font-weight-bold">{{ item.surveyName }}</span>
                  </td>
                  <td>
                    <span class="text-xs font-weight-bold">{{ item.voteCount }}</span>
                  </td>
        ...
        >
          <div class="modal-content">
            ...
            <div class="details-content">
              ...
              <p><strong>Aldığı Oy Sayısı:</strong> {{ selectedContent.voteCount }}</p>
            </div>
            <div class="modal-buttons">
  ...
  export default {
    ...
    data() {
      return {
        apiData: [
          { id: 1, imageUrl: "https://images.unsplash.com/photo-1519681393784-d120267933ba", imageName: "Bulutlu Dağ", surveyName: "Anket A", voteCount: 25 },
          { id: 2, imageUrl: "https://images.unsplash.com/photo-1532274402911-5a369e4c4bb5", imageName: "Nehir ve Bulut", surveyName: "Anket B", voteCount: 15 },
          { id: 3, imageUrl: "https://images.unsplash.com/photo-1472214103451-9374e3e8f8b9", imageName: "Şehir Üstü Bulut", surveyName: "Anket A", voteCount: 30 },
          { id: 4, imageUrl: "https://images.unsplash.com/photo-1506748686214-e9df14d4d9d0", imageName: "Doğa ve Bulut", surveyName: "Anket C", voteCount: 10 },
          { id: 5, imageUrl: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e", imageName: "Plaj Gökyüzü", surveyName: "Anket B", voteCount: 20 },
          { id: 6, imageUrl: "https://images.unsplash.com/photo-1519125323398-675f398f6978", imageName: "Deniz Bulutları", surveyName: "Anket A", voteCount: 18 },
          { id: 7, imageUrl: "https://images.unsplash.com/photo-1494545261862-8775175f85f2", imageName: "Orman Gökyüzü", surveyName: "Anket C", voteCount: 12 },
          { id: 8, imageUrl: "https://images.unsplash.com/photo-1518837695005-208458cedf24", imageName: "Gün Batımı Bulut", surveyName: "Anket B", voteCount: 22 },
          { id: 9, imageUrl: "https://images.unsplash.com/photo-1501785886575-9d8f8c8e8e8e", imageName: "Çiçek ve Bulut", surveyName: "Anket A", voteCount: 28 },
          { id: 10, imageUrl: "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b", imageName: "Şehir Bulutları", surveyName: "Anket C", voteCount: 14 }
        ],
        noDataMessage: "",
        currentPage: 1,
        itemsPerPage: 5,
    ...
    methods: {
      ...
      saveNewSurveyContent() {
        if (
          ...
          alert("Resim adı, anket adı boş olamaz ve aldığı oy sayısı geçerli bir tam sayı olmalı!");
        }
      },
