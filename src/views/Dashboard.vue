...
const fetchData = async () => {
  ...
  try {
    ...
    const totalUsersResponse = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetTotal",
      {},
      {
        headers: {
    ...
    const lastDayResponse = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetLastDay",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const lastHourResponse = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetLastHour",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const lastFiveMinutesResponse = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetLastFiveMinute",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const getMostCities = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetMostCities",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const chartResponse1 = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetTotalActiveUserLastYear",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
    ...
    const chartResponse2 = await axios.post(
      "http://213.238.181.142/api/Dashboard/GetTotalActiveUserCountLastYear",
      {},
      {
        headers: {
          Authorization: `Bearer ${token}`,
